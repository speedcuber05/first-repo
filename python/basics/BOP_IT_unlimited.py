...
#you can call a function for the msgs
# just make all the inputs in a list or somrthing and it will pull out a random one,
#  you will sacrifice the "pull it " and stuff but then you can add all the letters